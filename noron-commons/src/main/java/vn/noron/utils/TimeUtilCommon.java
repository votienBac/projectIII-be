...
public class TimeUtilCommon {

    private static final Logger LOG = LoggerFactory.getLogger(TimeUtilCommon.class);
    ...
    public static void main(String[] args) {
        OffsetDateTime now = atStartOfDay(Date.from(Instant.now()));
        System.out.println("cc");
    }
    public static OffsetDateTime atStartOfDay(Date date) {
        LocalDateTime localDateTime = dateToLocalDateTime(date);
        LocalDateTime startOfDay = localDateTime.with(LocalTime.MIN);
        return localDateTimeToDate(startOfDay);
    }

    public static OffsetDateTime atEndOfDay(Date date) {
        LocalDateTime localDateTime = dateToLocalDateTime(date);
    ...
    private static OffsetDateTime localDateTimeToDate(LocalDateTime localDateTime) {
    ...
    @SneakyThrows
    public static OffsetDateTime stringToOffsetDateTime(String dateStr) {
        return convertDateToOffsetDateTime(stringToDate(dateStr));
    }

    @SneakyThrows
    public static String offsetDateTimeToString(OffsetDateTime offsetDateTime) {
        return dateToString(convertOffsetDateTimeToDate(offsetDateTime));
    }
    ...
    public static Field<Object> unixTimestamp(Field field) {
        String fieldName = field.toString();
        return DSL.field("unix_timestamp(" + fieldName.replaceAll("\"", "`") + ")");
    }
...
//    }
    ...
    public static Pair<Long, Long> initStartAndEndOfYear(Integer year) {
        Calendar cal = Calendar.getInstance();
        ...
        return Pair.of(start.getTime(), end.getTime());
    }
...
//        System.out.println(TimeUtilCommon.getCurrentTimeLong() / 1000);
...
//    }
    ...
    public static Map<OffsetDateTime, OffsetDateTime> convertATimeToInterval(OffsetDateTime givenDay){
        int year = givenDay.getYear();
        int month = givenDay.getMonthValue();
        int day = givenDay.getDayOfMonth()+1;
        OffsetDateTime beginGivenDay = OffsetDateTime.of(year, month, day, 0, 0, 0, 0, ZoneOffset.of("+00:00"));
        OffsetDateTime endGivenDay = OffsetDateTime.of(year, month, day, 23, 59, 59, 9999, ZoneOffset.of("+00:00"));
        Map<OffsetDateTime, OffsetDateTime> interval = new HashMap<>();
        interval.put(beginGivenDay,endGivenDay );
        return interval;
    }
}